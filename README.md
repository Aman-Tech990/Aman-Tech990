...
I'm going deeper into **System Design**, **Backend Systems** & **Microservices**, **Cloud & DevOps**, **Generative AI**, and **Agentic AI**. I'm actively building with **RAG**, **LangChain**, **LangGraph**, **AWS** and **CI/CD**, integrating them with modern web applications to build practical AI-powered products.
